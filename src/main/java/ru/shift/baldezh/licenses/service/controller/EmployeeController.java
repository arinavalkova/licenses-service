...
public class EmployeeController {
    ...
    public List<LicenseEntity> getFilteredLicenseList(@RequestBody String filter) {
        return employeeService.getLicenseList(filter);
    }

    @GetMapping("license/count")
    public int getFilteredLicenseCount(@RequestBody String filter) {
        return employeeService.getLicenseCount(filter);
    }

    @GetMapping("user/list")
    public List<UserInfoEntity> getFilteredUserList(@RequestBody String filter) {
        return employeeService.getUserList(filter);
    }

    @GetMapping("user/count")
    public int getFilteredUserCount(@RequestBody String filter) {
